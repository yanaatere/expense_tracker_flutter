...
class WalletExpenseScreen extends StatefulWidget {
  ...
  @override
  State<WalletExpenseScreen> createState() => _WalletExpenseScreenState();
}
...
class _WalletExpenseScreenState extends State<WalletExpenseScreen> {
  ...
  double get _totalExpense => _filtered.fold(0.0, (sum, t) {
    final raw = t['amount'];
  ...
  String get _overviewLabel =>
      _monthly ? 'Monthly Expense Overview' : 'Annual Expense Overview';
                        ...
                        children: [
                          ...
                          if (_loading)
                            ...
                            ..._categoryTotals.keys.toList().asMap().entries.map((e) => _CategoryLegendRow(
                                  ...
                                  total: _totalExpense,
                                  currency: widget.wallet.currency,
                                  color: categoryColor(e.value, type: 'expense', fallbackIndex: e.key),
                                )),
                          ] else
                            Text(
                              formatCurrency(_totalExpense, widget.wallet.currency),
                              style: GoogleFonts.urbanist(
                                fontSize: 30,
